  ...
  return (
    <div className="h-screen w-full max-w-[430px] mx-auto flex flex-col justify-between bg-[#F3F8F8] font-sans overflow-hidden pb-4 relative">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="mt-3">
              ...
              <p className="text-[10.5px] text-white/80 font-medium leading-none mt-0.5">
                Create an account and start saving today! 🛍️
              </p>
            </div>
          </div>
      ...
      <div className="px-5 -mt-5 relative z-10 flex-1 flex flex-col justify-center">
        <div className="bg-white rounded-[28px] px-5 py-3.5 shadow-[0_4px_24px_rgba(0,0,0,0.03)] border border-[#E3ECEC] flex flex-col items-center">
          {/* Circular Mobile/Bubble Icon */}
          <div className="w-[44px] h-[44px] rounded-full border border-dashed border-[#009294]/30 flex items-center justify-center bg-[#F2FAF9] mb-2">
            <div className="w-[32px] h-[32px] rounded-full bg-[#009294]/10 flex items-center justify-center">
          ...
          <h2 className="text-[17px] font-extrabold text-[#0E1E1E] text-center leading-none">Create your account</h2>
          <p className="text-[11px] text-[#5A6E6E] font-medium mt-1 mb-3 text-center">
            Fill in your details to get started
          </p>

          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-2.5">
            {/* Full Name Input */}
            <div className="flex items-center bg-[#F7FBFB] border border-[#D5E2E2] rounded-2xl overflow-hidden h-[42px] focus-within:border-[#009294] focus-within:ring-2 focus-within:ring-[#009294]/10 transition-all">
              {/* Icon Block */}
              <div className="bg-[#006C6E] text-white flex items-center justify-center px-3 h-full select-none">
              ...
              <div className="flex-1 flex items-center gap-2 px-2.5">
                <input
                  ...
                  className="flex-1 bg-transparent text-[13px] font-semibold text-[#0E1E1E] placeholder:text-[#9FB1B1] outline-none border-none py-1"
                  required
                />
              </div>
            </div>
            ...
            <label className="flex items-start gap-2 cursor-pointer mt-0.5">
              ...
              <span className="text-[10px] text-[#5A6E6E] font-semibold leading-tight">
                I agree to the <span onClick={(e) => { e.stopPropagation(); navigate('/terms'); }} className="text-[#009294] font-bold cursor-pointer hover:underline">Terms</span> and <span onClick={(e) => { e.stopPropagation(); navigate('/privacy-policy'); }} className="text-[#009294] font-bold cursor-pointer hover:underline">Privacy Policy</span>
              </span>
            </label>
            ...
            <button
              ...
              className="w-full h-[42px] bg-gradient-to-r from-[#009294] to-[#006C6E] rounded-2xl text-white text-[14px] font-bold flex items-center justify-center gap-1.5 shadow-md shadow-[#009294]/15 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100 mt-1"
            >
            ...
            {/* Privacy Badge Block (Super Compacted) */}
            <div className="flex items-center gap-2 bg-[#F0FAF9] border border-[#DCF2F0] rounded-xl px-2.5 py-1.5">
              <svg className="w-3.5 h-3.5 text-[#14B8A6] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4" />
              </svg>
              <p className="text-[9.5px] text-[#5A6E6E] font-medium leading-none">
                <span className="font-bold text-[#0E1E1E]">Privacy Guaranteed.</span> Your number is safe.
              </p>
            </div>

            {/* Link to Login */}
            <div className="flex items-center justify-center gap-1 text-[11px] text-[#5A6E6E] font-medium">
