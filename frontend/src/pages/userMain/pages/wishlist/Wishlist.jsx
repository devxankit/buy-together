    ...
    <div className="flex flex-col min-h-[100dvh] w-full max-w-[430px] mx-auto bg-[#FAFAFA] font-sans pb-20">
      <div className="flex items-center justify-between px-5 pt-6 pb-4 bg-white sticky top-0 z-30 shadow-sm shadow-slate-100">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-extrabold text-[#1E293B]">My Wishlist</h1>
        </div>
      </div>
      ...
      <div className="px-5 py-4">
        {wishlistItems.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-sm text-slate-500 max-w-[250px]">Explore groups and tap the heart icon to save them for later.</p>
            <button 
          ...
          <div className="grid grid-cols-2 gap-4">
            {wishlistItems.map((group, index) => (
              <div 
                ...
                className="bg-white rounded-2xl overflow-hidden shadow-[0_4px_15px_rgba(0,0,0,0.03)] border border-slate-100 flex flex-col active:scale-95 transition-transform"
              >
                <div className="h-32 bg-slate-100 relative w-full">
                  ...
                  <div className="absolute top-2 left-2 bg-white/90 backdrop-blur-sm px-2 py-0.5 rounded-md text-[9px] font-bold text-slate-700 shadow-sm">
                ...
                <div className="p-3 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="font-bold text-slate-800 text-xs leading-tight line-clamp-2">{group.title}</h3>
                  </div>
                  
                  <div className="mt-2.5 pt-2.5 border-t border-slate-50 flex items-center justify-between">
                    <div className="flex items-baseline gap-1">
                      <span className="text-slate-400 text-[10px] line-through">₹{group.originalPrice || '0'}</span>
