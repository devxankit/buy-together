...
const TopBar = ({ navigate, user, onlineStatus }) => (
...
const ChatMessage = ({ id, avatar, name, role, time, content, image, video, reactions, replyTo, quoteData, onVote, documentData, locationData, voiceData, onLongPress, replyData, onLike, onReply, uploading, isMe }) => {
  let pressTimer = null;
  let lastTap = 0;
  let startX = 0;
...
const PersonalChat = () => {
  ...
  }, [liveMessages, messages, currentUserId, activePartner]);
  ...
  return (
    <div className="flex flex-col h-screen h-[100dvh] w-full max-w-[430px] mx-auto bg-[#F6F6F8] relative overflow-hidden">
      <TopBar navigate={navigate} user={activePartner} onlineStatus={onlineStatus} />
