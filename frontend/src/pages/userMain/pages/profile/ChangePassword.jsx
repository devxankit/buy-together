  ...
  return (
    <div className="flex flex-col min-h-[100dvh] w-full max-w-[430px] mx-auto bg-[#FAFAFA] font-sans">
      <div className="flex items-center gap-3 px-5 pt-5 pb-4 bg-white border-b border-slate-100 sticky top-0 z-20">
        ...
        <h1 className="text-[15px] font-black text-slate-800">Change Password</h1>
      </div>
      ...
      <div className="flex-1 px-5 py-6 flex flex-col gap-5">
        ...
        <div className="border-2 border-slate-100 rounded-2xl px-4 py-3.5 bg-white focus-within:border-[#0D9488] transition-all">
          <p className="text-[10px] font-bold text-slate-400 mb-1.5">Registered Phone / Email</p>
          <input type="text" value={phone} onChange={e => setPhone(e.target.value)} placeholder="Enter phone or email" className="w-full text-[14px] font-bold text-slate-800 placeholder:text-slate-300 bg-transparent outline-none" />
        </div>
        ...
        <button onClick={() => setSent(true)} className="w-full h-[50px] bg-[#0D9488] rounded-2xl text-white text-[14px] font-black flex items-center justify-center gap-2 shadow-lg shadow-teal-500/25 active:scale-95 transition-all">
