...
router.delete('/messages/:groupId/:messageId', auth, chatController.deleteMessage);
router.post('/messages/:groupId/:messageId/react', auth, chatController.reactMessage);
...
router.patch('/conversations/:otherUserId/read', auth, chatController.clearUnreadCount);
